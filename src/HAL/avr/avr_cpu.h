...
namespace UHAL
{
    ...
    template<> struct pins<AVR_ATmega2560>
    {
        typedef  enum {
    ...
    template<> struct pins<AVR_ATmega328P>
    {
                typedef  enum {
    ...
    template< avr_cpu_type cpu> class GenericCPU< cpu>
    {
            ...
            public:
                ...
                typedef pins<AVR_ATmega328P>::pin_type cpu_pins;
#endif
            ...
            public:
                static const long ClockMhz = F_CPU;
                typedef pins<AVR_ATmega2560>::pin_type cpu_pins;
#endif
    };
